...
def get_texts(lang: str) -> Dict[str, str]:
    if lang == "en":
        return {
            ...
            "support_text": (
                ...
                "• `@admin_username_1`\n"
                "• `@admin_username_2`\n\n"
                "_Replace these usernames with the actual contacts of your team._"
            ),
        }
    ...
    if lang == "es":
        return {
            ...
            "support_text": (
                ...
                "• `@admin_username_1`\n"
                "• `@admin_username_2`\n\n"
                "_Sustituye estos nombres de usuario por los contactos reales de tu equipo._"
            ),
        }
    ...
    return {
        ...
        "support_text": (
            ...
            "• `@admin_username_1`\n"
            "• `@admin_username_2`\n\n"
            "_Замените эти юзернеймы на реальные контакты вашей команды._"
        ),
    }
